...
{
    [TestClass]
    public class BaseUtilitiesUnitTest
    {
        private static TestContext _testContext;
        public TestContext TestContext { get; set; }
        public static string StandardOutput;
        public BaseUtilitiesUnitTest()
        {
            Log.Initialize();
        }
        ...
        public static class Verify
        {
            ...
            public static void IsTrue(bool value, string message)
            {
                ...
                try
                {
                    ...
                    {
                        var errorMessage = new ErrorMessage($"Expected the condition to be True but was False. Message: {message} {ex.Message}");
